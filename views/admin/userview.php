  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addNewForm" method="POST" action="../../controllers/admin/usercontroller.php">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="editModalBody">
        <form id="editForm" action="../../controllers/admin/usercontroller.php" method="POST">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="deleteModalBody">
        ...
        <form id="deleteForm" method="POST" action="../../controllers/admin/usercontroller.php">
...
<script>
  function openEditModal(user_id, username, password, name, phone, email,role) {
    console.log("Bạn đã nhấn vào đây");
